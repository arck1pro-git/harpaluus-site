    ...
    <div className="flex items-stretch bg-linha">
      ...
      <div className="flex flex-1 flex-col">
        <div className="grid grid-cols-4 h-[220px]">
          <div className="relative overflow-hidden rounded-lg border border-linha bg-verde-escuro">
        ...
        {/* tourmaline */}
        <div className="group relative flex min-h-[480px] flex-col items-center justify-end overflow-hidden rounded-lg border border-linha bg-verde-escuro py-[60px] px-10">
